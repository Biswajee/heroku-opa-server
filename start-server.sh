...
curl -X PUT -d @data/admin-users.json opa-auth-server.herokuapp.com:80/v1/data/sudo/authz/roles --header "Content-Type: application/json"
curl -X GET opa-auth-server.herokuapp.com:80/v1/policies/sudo/authz
curl -X GET opa-auth-server.herokuapp.com:80/v1/data/sudo/authz/roles
wait
